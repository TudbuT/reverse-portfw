...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        if(args.length == 0) {
            ...
            System.err.println("  java -jar reverse-portfw.jar client <ip> <port> <destinationPort> <key>");
            return;
        }
        if(args[0].equals("client") && args.length == 5) {
            Client.start(args[1], Integer.parseInt(args[2]), Integer.parseInt(args[3]), args[4]);
        }
